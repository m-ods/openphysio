...
import { systemPrompt } from "./prompts/physio-assistant.ts";
...
export const appConfig: AppConfig = {
  ...
  systemPrompt: (_req, context) => systemPrompt
    .replace("**current date**", new Date().toDateString())
    .replace("**city and country**", `${context.geo.city}, ${context.geo.country}`),
};
